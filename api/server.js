...
No markdown, no explanation outside the JSON, just the JSON array.`;
  ...
  const POOL = {
    PYTHON: [
      { question: "What does 'yield' do in Python?", options: ["Returns a generator value", "Breaks a loop", "Imports a module", "Declares a variable"], answer: "Returns a generator value", explanation: "'yield' pauses function execution and sends a value back to the caller, effectively turning the function into a memory-efficient generator." },
      { question: "Which method removes and returns the last item of a list?", options: ["pop()", "remove()", "delete()", "discard()"], answer: "pop()", explanation: "The 'pop()' method inherently returns the element it removes, defaulting to the last index (-1) if no index is provided." },
      { question: "What is a lambda in Python?", options: ["An anonymous function", "A loop type", "A class decorator", "A module"], answer: "An anonymous function", explanation: "Lambdas are single-expression anonymous functions defined inline using the 'lambda' keyword, often used for short, throwaway operations." },
      { question: "What does 'is' operator check?", options: ["Identity (same object)", "Equality of value", "Data type", "Membership"], answer: "Identity (same object)", explanation: "The 'is' operator compares object memory addresses (identity), unlike '==' which compares the actual values contained within." },
      { question: "Which of these is a valid dictionary comprehension?", options: ["{k: v for k, v in items}", "[k: v for k, v in items]", "(k: v for k, v in items)", "{k, v for k, v in items}"], answer: "{k: v for k, v in items}", explanation: "Dictionary comprehensions use curly braces '{}' and the 'key: value' syntax within an iteration loop to concisely build dictionaries." },
      { question: "What is '__init__' in Python?", options: ["Constructor method", "Destructor method", "Static method", "Class variable"], answer: "Constructor method", explanation: "'__init__' is the standard initializer (constructor) method called automatically when a new instance of a class is instantiated." },
      { question: "What module is used for regular expressions?", options: ["re", "regex", "regexp", "string"], answer: "re", explanation: "The built-in 're' module provides regular expression matching operations, compiling patterns into regex objects for string processing." },
      { question: "Which keyword creates a generator?", options: ["yield", "return", "generate", "async"], answer: "yield", explanation: "Using 'yield' instead of 'return' within a function transforms it into a generator, allowing it to produce a sequence of values lazily." },
      { question: "What does 'enumerate()' return?", options: ["Index and value pairs", "Only values", "Only indices", "A dictionary"], answer: "Index and value pairs", explanation: "'enumerate()' wraps an iterable, returning a new iterable of tuples containing a running count (index) alongside the original values." },
      { question: "Which method adds an element to a set?", options: ["add()", "append()", "insert()", "push()"], answer: "add()", explanation: "Sets use the 'add()' method to insert single elements. Lists use 'append()', which is not applicable to unordered collections like sets." },
      { question: "What is the GIL in Python?", options: ["Global Interpreter Lock", "Global Instance Library", "General Input Layer", "Generic Iteration Loop"], answer: "Global Interpreter Lock", explanation: "The GIL (Global Interpreter Lock) prevents multiple native threads from executing Python bytecodes at once, ensuring CPython memory safety." },
      { question: "What does '*args' mean?", options: ["Variable positional arguments", "Required arguments", "Keyword arguments", "Default arguments"], answer: "Variable positional arguments", explanation: "'*args' unpacks a variable number of non-keyword positional arguments into a tuple, allowing functions to accept arbitrary inputs." },
      { question: "Which built-in sorts a list in-place?", options: ["list.sort()", "sorted()", "list.order()", "list.arrange()"], answer: "list.sort()", explanation: "Calling '.sort()' on a list object mutates the list in-place, whereas the 'sorted()' function creates and returns a brand new sorted list." },
      { question: "What is a Python decorator?", options: ["A function that modifies another function", "A class attribute", "A type of loop", "A module alias"], answer: "A function that modifies another function", explanation: "Decorators are higher-order functions that take a function, extend its behavior without explicitly modifying it, and return the wrapper." },
      { question: "Which data type is unordered and unique?", options: ["set", "list", "tuple", "dict"], answer: "set", explanation: "Sets are fundamentally implemented as hash tables containing only keys, making them inherently unordered collections of unique elements." },
      { question: "Which of these is immutable in Python?", options: ["Tuple", "List", "Dictionary", "Set"], answer: "Tuple", explanation: "Tuples, unlike lists or dictionaries, cannot be altered after creation. Their immutable nature makes them hashable and memory efficient." },
      { question: "How do you define a function in Python?", options: ["def my_func():", "function my_func():", "func my_func():", "create my_func():"], answer: "def my_func():", explanation: "The 'def' keyword is the standard syntax for defining a named function or method block in Python." },
      { question: "What is the output of 2**3 in Python?", options: ["8", "6", "9", "5"], answer: "8", explanation: "The '**' operator acts as the exponentiation operator in Python, so 2**3 calculates 2 raised to the power of 3, which equals 8." }
    ],
    JAVA: [
